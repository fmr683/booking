...
<br/>
  <div class="row">
      <div class="col-sm-10 col-xs-6">  <div class="alert alert-warning" role="alert">If there are bookings attached to this mapping, then if you delete it; related booking will not appear</b> </div></div>
